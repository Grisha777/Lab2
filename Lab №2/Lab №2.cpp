...
ofstream foutb("Vector.dat ", ios::binary); // открываем файл для записи в текстовом режиме
foutb.write((char*)&m1, sizeof(m1)); // записываем n в двоичном режиме
{
	foutb << "V1= " << ends<< "V2= " <<ends; // после строк вставляем 0, как признак конца
}
